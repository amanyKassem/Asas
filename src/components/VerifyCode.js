            ...
            <Container >
                <Content style={{ padding: 30 }}>
                    ...
                    <View style={{flex: 1 , justifyContent:'center', marginBottom:30 , alignItems:'center'}}>
                        <Text style={{color:"#a1a1a1" , fontFamily:"RegularFont"  , fontSize:16 }}>ادخل كود التحقق المرسل اليك</Text>
                    </View>
                    <Form style={{ width:"100%"}}>
                        <Item  style={{marginLeft:0 , borderColor:'#ebebeb' , borderTopWidth:0, borderRightWidth:1, borderLeftWidth:1, borderBottomWidth:2 , marginBottom:13}}>
                            ...
                            />
                            <Icon name={'check'} type={'FontAwesome'} style={{ position: 'absolute', top: 15, left: 3, color: "#ebebeb" , fontSize:17}}/>
                        </Item>
                        <Item  style={{marginLeft:0 , borderColor:'#ebebeb' , borderTopWidth:0, borderRightWidth:1, borderLeftWidth:1, borderBottomWidth:2 , marginBottom:13}}>
                        ...
                        <Item  style={{marginLeft:0 , borderColor:'#ebebeb' , borderTopWidth:0, borderRightWidth:1, borderLeftWidth:1, borderBottomWidth:2 , marginBottom:13}}>
                            <Input placeholder="تأكيد كلمة المرور الجديدة"
                                   style={styles.input}
                                   placeholderTextColor={{ color: '#a7a7a7' }}
                                   secureTextEntry
                                   autoCapitalize='none'
